...
public class WXPay {
   ...
   public String requestWithoutCert(String strUrl, Map reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
      String UTF8 = "UTF-8";
   ...
   public String requestWithCert(String strUrl, Map reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
      String UTF8 = "UTF-8";
      String reqBody = WXPayUtil.mapToXml(reqData);
      URL httpUrl = new URL(strUrl);
